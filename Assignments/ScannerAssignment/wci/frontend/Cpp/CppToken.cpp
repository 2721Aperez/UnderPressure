...
namespace wci { namespace frontend { namespace Cpp {
    ...
    void CppToken::initialize()
    {
        ...
        vector<string> rw_strings =
        {
            ...
            "if", "int", "long", "namespace", "operator", "protected", "public",
            "return", "static", "struct", "switch", "template", "this",
            "throw", "union", "void", "while"
        };
        ...
        vector<string> ss_names =
        {
            ...
            "SLASH_EQUALS", "EQUALS_EQUALS", "OR_EQUALS", "PERCENT_EQUALS",
